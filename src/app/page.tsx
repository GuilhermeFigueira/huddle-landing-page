...
export default function Home() {
	return (
		<main className="h-screen w-screen bg-violet text-white bg-[url('/bg-mobile.svg')] bg-top bg-contain bg-no-repeat lg:bg-[url('/bg-desktop.svg')] lg:bg-cover lg:bg-right flex flex-col gap-8">
